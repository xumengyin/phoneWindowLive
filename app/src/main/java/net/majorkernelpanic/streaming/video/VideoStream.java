...
//		}
	...
	@SuppressLint("NewApi")
	protected void ecodeTest() throws RuntimeException, IOException
	{
	//	mQuality.framerate=20;
//		mQuality.resX=360;
//		mQuality.resY=540;
		...
		//MediaFormat mediaFormat = MediaFormat.createVideoFormat("video/avc", 720, mQuality.resY);
...
//		mediaFormat.setInteger(MediaFormat.KEY_COMPLEXITY, MediaCodecInfo.EncoderCapabilities.BITRATE_MODE_CBR);
		...
		mVirtualDisplay = mediaProjection.createVirtualDisplay(TAG + "-display",
				mQuality.resX,mQuality.resY, 1, DisplayManager.VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR,
                  mSurface, null, null);
